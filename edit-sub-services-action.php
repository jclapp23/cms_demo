...
$home_url = HOME;
  ...
  if(services::updateSubService($id,addslashes($title),addslashes($short_title)))
    {
      echo "The sub service has been updated successfully.";
      echo "<br/>";
      echo "<a href='".$home_url."new-hampshire-stone-mason-services/'>Go back to services page.</a>";
    }
    else
    {
      echo "The was an error attempting to update the sub service.";
      echo "<br/>";
